...
|---|---|---|---|
| 📚 Library Management | Java console app for book catalog | Java, OOP, CSV, Git | [library-java](link) |
| 🔌 Library REST API | Spring Boot REST API for book catalog | Spring Boot, JPA, H2 | [todo-api](link) |
